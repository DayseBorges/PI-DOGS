        ...
        <>
            <div className={styles.back}>
                ...
                <div className={styles.allText}>
                    <h1 className={styles.love}>WE L<span className={styles.corazon}>❤</span>VE DOGS!</h1>
                    <h2 className={styles.text}>That's why here you can find <br /> everything about your best friend...</h2>
                    <Link to="/home" >
